  ...
  <div>
    <md-card class="md-elevation-5">
      ...
      <div class="md-layout-item">
        ...
        <md-button class="md-raised md-primary button_spacing" v-on:click="getPoaValidators"><md-icon>refresh</md-icon></md-button>
      </md-card-header>
      ...
      <md-card-content>
        <br />
         <md-table >
            ...
            <md-table-row v-for="validator in validators" :key="validator.address">
              <md-table-cell>{{validator.description.moniker}}</md-table-cell>
              <md-table-cell class="address">{{validator.address}}</md-table-cell>
	      ...
	      --->
              <md-table-cell><md-menu :md-offset-x="127" :md-offset-y="-36">
